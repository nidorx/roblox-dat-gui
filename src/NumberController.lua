...
local TEMPLATE = script.Parent:WaitForChild("TEMPLATE"):WaitForChild("MAIN"):WaitForChild("NumberController")

-- Represents a given property of an object that is a number.
function NumberController(gui, object, property, min, max, step)
